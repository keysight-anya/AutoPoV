...
import { ChevronDown, ChevronUp, FileCode, AlertTriangle, CheckCircle, Code } from 'lucide-react'
    ...
    <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
      ...
      {expanded && (
        <div className="border-t border-gray-800 p-4 space-y-4">
          ...
          {/* Metadata */}
          <div className="flex items-center space-x-6 text-sm text-gray-500 pt-2 border-t border-gray-800">
